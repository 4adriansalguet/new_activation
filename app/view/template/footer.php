        ...
        <div class="footer_wrapper">
            <div class="contact_us">
                ...
                <form action="">
                    ...
                    <textarea cols="30" rows="6" class="form-control" placeholder="Message / Questions:"></textarea>
                    <div class="submit_btn">
                        <button type="submit" class="contact_us_btn">Submit form</button>
                    </div>
                </form>
            </div>
                ...
                <div class="information-wrapper">
                    ...
                    <div class="row-info-contact">
                        ...
                        <div class="col-info">
                            ...
                            <div class="info-content">
                                <p>Email</p>
                                <h6>info@renderingsplus.com</h6>
                            </div>
                        </div>
                    </div>
                    <div class="information-social">
                        <a href="#"><img src="<?php echo URL ?>./public/images/icons/facebook.fw.png"
                                alt="footer facebook"></a>
                        <a href="#"><img src="<?php echo URL ?>./public/images/icons/instagram.fw.png"
